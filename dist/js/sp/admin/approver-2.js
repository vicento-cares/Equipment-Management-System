...
document.addEventListener("DOMContentLoaded", () => {
  ...
  load_notif_sp_pending_mstprc_page();
  realtime_load_notif_sp_pending_mstprc_page = setInterval(load_notif_sp_pending_mstprc_page, 5000);

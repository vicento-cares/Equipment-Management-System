...
var realtime_get_machine_checksheets_qa;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  get_machine_checksheets_qa();
  realtime_get_machine_checksheets_qa = setInterval(get_machine_checksheets_qa, 5000);
...
const get_details_machine_checksheets_qa = el => {
  ...
  $.ajax({
    ...
    cache: false,
    data: {
      method: 'machine_checksheets_mark_as_read_qa',
...
const count_machine_checksheets_qa = () => {
  ...
  $.ajax({
    ...
    cache: false,
    data: {
      method: 'count_machine_checksheets_qa',
      car_model:car_model,
      location:location,
...
const get_machine_checksheets_qa = () => {
  ...
  $.ajax({
    ...
    cache: false,
    data: {
      method: 'get_machine_checksheets_qa',
      car_model:car_model,
      location:location,
      machine_name:machine_name,
      grid:grid,
  ...
  .fail((jqXHR, textStatus, errorThrown) => {
    ...
    if (textStatus == "timeout") {
      ...
      clearInterval(realtime_get_machine_checksheets_qa);
...
const get_pm_records_qa = option => {
  var id = 0;

...
const count_sou_history = () => {
  ...
  var sou_status = sessionStorage.getItem('sou_history_status');
...
const get_sou_history = option => {
  ...
  switch (option) {
    case 1:
      ...
      var sou_status = document.getElementById("sou_history_status").value;
      ...
      success: response => {
        switch (option) {
          case 1:
            ...
            sessionStorage.setItem('sou_history_status', sou_status);
            break;
          case 2:
...
const count_fat_history = () => {
  ...
  var fat_status = sessionStorage.getItem('fat_history_status');
...
const get_fat_history = option => {
  ...
  switch (option) {
    case 1:
      ...
      var fat_status = document.getElementById("fat_history_status").value;
      if (date_updated_from == '' || date_updated_to == '') {
        var continue_loading = false;
        swal('Approver 3', 'Fill out all date fields', 'info');
      }
      ...
      success: response => {
        switch (option) {
          case 1:
            ...
            sessionStorage.setItem('fat_history_status', fat_status);
            break;
          case 2:

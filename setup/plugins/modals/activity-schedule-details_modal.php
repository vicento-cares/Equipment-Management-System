          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control" id="u_activity_date" disabled>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <textarea id="u_act_sched_details" class="form-control" style="resize: none;" rows="3" maxlength="255" disabled></textarea>
              </div>
            </div>
          </div>
        </form>

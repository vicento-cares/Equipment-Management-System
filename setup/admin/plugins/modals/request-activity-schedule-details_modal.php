  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-light">
        ...
        <button type="button" class="btn bg-success" id="btnAcceptSched" onclick="accept_activity_schedule()">Accept Schedule</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal" data-toggle="modal" data-target="#DeclineSchedModal" id="btnGoDeclineSched">Decline Schedule</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>

        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_no" class="ml-2"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Checksheet Type : </label>
              <span id="recent_mstprc_type" class="ml-2"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_machine_name" class="ml-2"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Machine No. : </label>
              <span id="recent_mstprc_machine_no" class="ml-2"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_line_car_model" class="ml-2"></span>
          ...
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_equipment_no" class="ml-2"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_date" class="ml-2"></span>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_eq_member" class="ml-2"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Checked By (Safety Officer) : </label>
              <span id="recent_mstprc_safety_officer" class="ml-2"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_eq_g_leader" class="ml-2"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Approved By (Production Engineering Manager) : </label>
              <span id="recent_mstprc_prod_engr_manager" class="ml-2"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_eq_sp_personnel" class="ml-2"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Noted By (Equipment Manager) : </label>
              <span id="recent_mstprc_eq_manager" class="ml-2"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_prod_supervisor_manager" class="ml-2"></span>
          ...
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_qa_supervisor_manager" class="ml-2"></span>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_from_line_car_model" class="ml-2"></span>
          ...
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_to_line_car_model" class="ml-2"></span>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_transfer_reason" class="ml-2"></span>
            </div>
          </div>
        </div>
        <div class="dropdown-divider"></div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_pullout_location" class="ml-2"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group mb-0">
              ...
              <span id="recent_mstprc_pullout_reason" class="ml-2"></span>
            </div>
          </div>
        </div>
        <div class="dropdown-divider"></div>

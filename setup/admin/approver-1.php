...
include('plugins/css/approver-1_stylesheet.php');
include('plugins/preloader.php');
include('plugins/navbar.php');
include('plugins/sidebar/approver-1_bar.php');
?>
            ...
            <div class="card card-lime card-outline collapsed-card">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-sm-center">
                  <button type="button" class="btn bg-lime" id="search_more_data2" style="display:none;" onclick="get_a1_machine_checksheets_history(2)">Load more</button>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
...
include('plugins/js/approver-1_script.php');
?>

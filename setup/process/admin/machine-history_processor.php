...
if ($method == 'get_machine_history') {
    ...
    $sql = "SELECT TOP 25 id, number, machine_name, machine_spec, car_model, location, grid, machine_no, equipment_no, asset_tag_no, trd_no, [ns_iv_no], machine_status, new_car_model, new_location, new_grid, pic, status_date, history_date_time FROM t_machine_history";
    $params = [];

        ...
        <tr>
          <td class="px-1 py-1">
            ...
            <div class="row ml-1">
              ...
              <span class="font-weight-bold" style="font-size:16px;"><?=htmlspecialchars($machine_name)?></span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">Machine No. :</span>
              <span class="font-weight-bold" style="font-size:16px;"><?=htmlspecialchars($machine_no)?></span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">Equipment No. :</span>
              <span class="font-weight-bold" style="font-size:16px;"><?=htmlspecialchars($equipment_no)?></span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">Setup By :</span>
              <span class="font-weight-bold" style="font-size:16px;"><?=htmlspecialchars($manpower)?></span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">Setup Date :</span>
              <span class="font-weight-bold" style="font-size:16px;"><?=date("Y-m-d", strtotime($ww_start_date))?></span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">Next PM Date :</span>
              <?php if (!empty($ww_next_date)) { ?>
              <span class="font-weight-bold" style="font-size:16px;"><?=date("Y-m-d", strtotime($ww_next_date))?></span>
              <?php } else { ?>
            ...
            <div class="row ml-1 mt-2">
              ...
              <span class="font-weight-bold" style="font-size:16px;"><?=htmlspecialchars($shift_engineer)?></span>
            </div>
          </td>
        </tr>
      </tbody>

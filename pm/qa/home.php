            ...
            <div class="card card-lime card-outline collapsed-card">
              ...
              <div class="card-body">
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-sm-3">
                    <label>Search</label>
                    <button type="button" class="btn bg-lime btn-block" onclick="get_pm_records_qa(1)"><i class="fas fa-search"></i> Search RSIR</button>
                  </div>
                </div>
                <div class="d-flex justify-content-sm-start">
                ...
                <div class="d-flex justify-content-sm-center">
                  <button type="button" class="btn bg-lime" id="search_more_data2" style="display:none;" onclick="get_pm_records_qa(2)">Load more</button>
                </div>
              </div>
              <!-- /.card-body -->
            </div>

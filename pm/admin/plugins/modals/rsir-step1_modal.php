  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <input list="rsir_machines_no" class="form-control" id="rsir_machine_no" maxlength="255">
                <datalist id="rsir_machines_no"></datalist>
              </div>
            </div>
            <div class="col-sm-6">
              <!-- text input -->
              <div class="form-group">
                ...
                <input list="rsir_equipments_no" class="form-control" id="rsir_equipment_no" maxlength="255">
                <datalist id="rsir_equipments_no"></datalist>
              </div>
            </div>
          </div>
          <div class="row">
      ...
      <div class="modal-footer bg-light">
        ...
        <button type="button" class="btn bg-gray" onclick="clear_rsir_step1_fields()">Clear</button>

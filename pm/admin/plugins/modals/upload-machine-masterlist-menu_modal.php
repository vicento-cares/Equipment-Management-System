        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div class="small-box bg-secondary">
              ...
              <a data-dismiss="modal" class="small-box-footer" style="cursor:pointer;" onclick="setTimeout(() => {$('#UploadOldMachineMasterlistCsvModal').modal('show');}, 400);">Upload Old Machines <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
        </div>
      </div>

      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>RSIR No. : </label>
              <span id="history_rsir_no2"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Kind of Inspection : </label>
              <span id="history_rsir_type2"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="history_rsir_machine_name2"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Machine No. : </label>
              <span id="history_rsir_machine_no2"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="history_rsir_equipment_no2"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="history_rsir_date2"></span>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="history_rsir_judgement_of_eq"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Judgement of Product : </label>
              <span id="history_rsir_judgement_of_prod"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="history_rsir_repair_details"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Inspected By : </label>
              <span id="history_rsir_inspected_by"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="history_rsir_repair_date"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Confirmed By : </label>
              <span id="history_rsir_confirmed_by"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="history_rsir_repaired_by"></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group mb-0">
              <label>Judgement By : </label>
              <span id="history_rsir_judgement_by"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group mb-0">
              ...
              <span id="history_rsir_next_pm_date"></span>
            </div>
          </div>
        </div>
        <div class="dropdown-divider"></div>

    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
          ...
          <li><a href="pm-records.php" class="dropdown-item active">PM Records </a></li>
          <li><a href="pm-work-orders.php" class="dropdown-item">PM Work Orders</a></li>
        </ul>
      </li>
      <li class="nav-item">
        <a href="/eems/pm/admin" class="nav-link"><i class="fas fa-sign-in-alt"></i> Login</a>
      </li>
    </ul>
  </div>
  ...
  <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <a href="/eems/pm/" class="dropdown-item" id="notif_done_pm_concerns">
          <i class="fas fa-check mr-2"></i> No new Done PM Concerns
          <span class="float-right text-muted text-sm"></span>
        </a>
        <div class="dropdown-divider"></div>
        <a href="/eems/pm/" class="dropdown-item" id="notif_pending_pm_concerns">
          <i class="fas fa-spinner mr-2"></i> No new Pending PM Concerns
          <span class="float-right text-muted text-sm"></span>
        </a>
        <div class="dropdown-divider"></div>
        <a href="/eems/pm/" class="dropdown-item dropdown-footer">See All PM Concerns</a>
      </div>
    </li>
    <li class="nav-item">

...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    $lineData = array($c, $row['pm_concern_id'], $row['machine_line'], $row['machine_name'], $row['car_model'], $row['trd_no'], $row['ns_iv_no'], $row['problem'], $row['request_by'], $row['confirm_by'], $row['comment'], $row['no_of_parts'], $concern_date_time);

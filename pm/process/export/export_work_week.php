...
$sql = "SELECT 
            id, number, process, machine_name, car_model, machine_no, equipment_no, pm_plan_year, ww_no, ww_start_date, frequency, manpower, sched_start_date_time, sched_end_date_time, machine_status, pm_status 

...
$pm_sticker_id_arr = [];
$pm_sticker_id_arr = explode(",", $_GET['pm_sticker_id_arr']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>EMS PM | Print Selected PM Sticker</title>
          ...
          <td class="px-1 py-1">
            <div class="row ml-1">
              <div class="d-flex justify-content-between">
                ...
                <span class="font-weight-bold ml-1" style="font-size:18px;">FURUKAWA AUTOMOTIVE SYSTEMS LIMA PHILIPPINES INC.</span>
              </div>
            </div>
            <div class="row ml-1 mb-1">
              <span class="font-weight-bold font-italic" style="font-size:16px;">Equipment PM Schedule Sticker</span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">Equipment Name :</span>
              <span class="font-weight-bold" style="font-size:16px;"><?=htmlspecialchars($row['machine_name'])?></span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">Machine No. :</span>
              <span class="font-weight-bold" style="font-size:16px;"><?=htmlspecialchars($row['machine_no'])?></span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">Equipment No. :</span>
              <span class="font-weight-bold" style="font-size:16px;"><?=htmlspecialchars($row['equipment_no'])?></span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">PM By :</span>
              <span class="font-weight-bold" style="font-size:16px;"><?=htmlspecialchars($row['manpower'])?></span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">PM Date :</span>
              <span class="font-weight-bold" style="font-size:16px;"><?=date("Y-m-d", strtotime($row['ww_start_date']))?></span>
            </div>
            <div class="row ml-1">
              <span class="mr-1" style="font-size:16px;">Next PM Date :</span>
              <?php if (!empty($row['ww_next_date'])) { ?>
              <span class="font-weight-bold" style="font-size:16px;"><?=date("Y-m-d", strtotime($row['ww_next_date']))?></span>
              <?php } else { ?>
            ...
            <div class="row ml-1 mt-2">
              ...
              <span class="font-weight-bold" style="font-size:16px;"><?=htmlspecialchars($row['shift_engineer'])?></span>
            </div>
          </td>
        </tr>
      </tbody>

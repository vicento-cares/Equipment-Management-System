    ...
    if (!empty($machine_no) || !empty($equipment_no)) {
        if (!empty($machine_name)) {
            ...
            if ($machine_info['registered'] == true) {
                ...
                echo 'Machine No. or Equipment No. not found / registered!!!';
        } else
            echo 'Please press Enter Key after typing Machine No. or Equipment No.';
    } else
        echo "Please fill out Machine No. or Equipment No.";
